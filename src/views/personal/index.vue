...
import UserCard from '@/views/personal/componments/UserCard'
import UserInfo from '@/views/personal/componments/UserInfo'
import UserDescriptions from '@/views/personal/componments/UserDescriptions'
import Social from '@/views/personal/componments/Social'
import Password from '@/views/personal/componments/Password'
