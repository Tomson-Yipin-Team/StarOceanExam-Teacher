    ...
    <el-row type="flex" justify="center">
      <el-card style="width: 70%;margin: 20px">
        ...
        <el-row slot="header" type="flex" justify="center">
          <el-col :span="10">
            <el-steps :active="active" finish-status="success" align-center style="margin-top: 10px;">
              <el-step title="创建" />
              <el-step title="确认信息" />
              <el-step title="完成" />
            </el-steps>
          ...
          <el-col :span="12">
            <el-form ref="basicForm" :model="form" label-width="80px">
              ...
              <el-form-item label="班级期限">
                <el-date-picker v-model="form.beginTime" type="date" placeholder="选择开始日期" style="width: 100%;margin-bottom: 20px" />
        ...
        <el-row v-show="active===2" type="flex" justify="center">
          ...
          <el-col :span="8">
            <el-card header="班级链接" shadow="hover" style="margin-left: 20px;margin-right: 20px">
              <el-row>
        ...
        <el-row style="margin-top: 20px;display: flex;justify-content: end;margin-right: 20px">
          <el-button v-if="active!==2" type="warning" plain @click="reset">重置</el-button>
          <el-button v-if="active===1" type="primary" plain @click="previous">上一步</el-button>
          <el-button v-if="active===2" type="primary" @click="previous">完成</el-button>
