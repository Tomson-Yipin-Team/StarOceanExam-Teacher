export default {
  studentAnswer: [{
    ...
    answer: [{
      questionId: 0,
      content: `A two-day visit to Fanhai Hope Elementary School organized by the Student Union of our university has been completed as scheduled this weekend.
    ...
    answer: [{
      questionId: 0,
      content: `A team of 30 college students' participated in this trip. The visit was warmly welcomed by all the students and staff of Fanhai, followed by a range of colorful activities, such as the interaction among students about the fascinating college life, a visit to the school art show of students' works of painting and handicraft and teaching activities focusing on showing the magical science world to the pupils.
      Both the pupils and our college students were actively involved in all these brilliant activities. And the headmaster of Fanhai spoke highly of this trip as well as the devotion, enthusiasm and creativity of our students.`
    }, {
      questionId: 1,
      content: 'Lanterns originated in the Eastern Han Dynasty, and were at first used primarily for lighting. In the Tang Dynasty, people used red lanterns to celebrate a stable life.'
    }]
  }],
  question: [{
    questionId: 0,
