  ...
  examinations: [
    {
      ...
      finishCorrect: '--',
      status: '正在进行',
      beginTime: '2022-04-06 16:00:00',
      endTime: '2022-04-06 18:00:40',
      paperInfo: {
        basicForm: {
          name: '2021-2022-2大学英语六级模拟考试（2）',
          category: '',
          date1: new Date(2022, 3, 1, 0, 0, 0),
          paper: '2021-2022-2大学英语六级模拟考试（2）',
...
本场考试为四级模拟考试，考试时间为16：00 - 18：00`,
    ...
    },
    {
      ...
      finishCorrect: '--',
      status: '即将开始',
      beginTime: '2022-03-14 8:00:00',
      endTime: '2022-03-14 10:00:00',
      paperInfo: {
        basicForm: {
          name: '2021-2022-2大学英语六级模拟考试（3）',
          category: '',
          date1: new Date(2022, 3, 1, 0, 0, 0),
          paper: '2021-2022-2大学英语六级模拟考试（3）',
          beginTime: new Date(2022, 3, 1, 14, 0, 0),
          endTime: new Date(2022, 3, 1, 16, 0, 0),
          delivery: false,
          resource: '',
    ...
    },
    {
      ...
      paperInfo: {
        basicForm: {
          name: '2022年6月全国大学生英语四级考试-模拟',
          category: '',
          date1: new Date(2022, 3, 1, 0, 0, 0),
          paper: '2022年6月全国大学生英语四级考试-模拟',
          beginTime: new Date(2022, 3, 1, 14, 0, 0),
          endTime: new Date(2022, 3, 1, 16, 0, 0),
          delivery: false,
          resource: '',
  ...
  papers: [
    ...
    },
    {
      id: '1000075886',
      date: '2022-03-08',
      name: '2021-2022-2普本大学英语（四）期末考试A卷',
      origin: '方慧敏',
      number: 20
    ...
    },
    {
      id: '1000075888',
      date: '2022-03-07',
      name: '2021-2022-2普本大学英语（四）期末考试B卷',
      origin: '汪美美',
      number: 20
    }
  ]
